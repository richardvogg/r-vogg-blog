...
title: "Fuzzy merging"
description: |
  Imagine that you have a list of hand-typed names/words and a list of reference. Fuzzy merging helps   to map Fantasy company & co. / FANTASY COMP / Fnatasy Company to the same entity "Fantasy Company"   from the reference list. 
author:
  - name: Richard Vogg
