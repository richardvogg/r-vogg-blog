...
While I am with ggplot (still have to google a lot, but I get from data to output quite fast), it took some time to get familiar with the logic behind ggraph. The good news is: It is similar to ggplot, so the plot is created with a layer-like grammar which converts the raw data in one of these beautiful visualizations.
...
p1 + p2 + p3 + p4 + p5 + p6 + p7 + p8 + guide_area() +
